        ...
        <div className="max-w-[1200px] mx-auto px-6 lg:px-12">
          <div className="mb-20 max-w-xl">
            ...
            <p className="text-lg text-zinc-500">
              Stop manipulating Excel files for payroll. We map Workday earning codes directly to your ERP's multi-dimensional segments.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-auto md:auto-rows-[300px]">
            ...
            <div className="md:col-span-2 relative bg-white border border-zinc-200 rounded-3xl p-8 overflow-hidden group shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="relative z-10 h-full flex flex-col justify-between">
                <div className="mb-8 md:mb-0">
                  ...
                  <h3 className="text-xl font-semibold text-zinc-900 mb-2">Earnings & Tax Mapping</h3>
                  <p className="text-zinc-500 max-w-sm text-sm leading-relaxed">
                    Automatically translate Workday specific earning codes, tax deductions, and benefits into the correct NetSuite liability and expense accounts.
                  </p>
                </div>
                {/* Mini Visualization */}
            ...
            <div className="bg-white border border-zinc-200 rounded-3xl p-8 flex flex-col justify-between group shadow-sm hover:shadow-md transition-shadow">
              <div className="mb-8 md:mb-0">
                ...
                <h3 className="text-xl font-semibold text-zinc-900 mb-2">Confidential Data</h3>
                <p className="text-zinc-500 text-sm leading-relaxed">
                  Payloads are aggregated to protect PII, pushing only GL impact without exposing individual salaries.
                </p>
              </div>
              <div className="h-16 bg-zinc-900 rounded-xl p-3 flex flex-col justify-center overflow-hidden">
                <div className="text-[10px] font-mono text-green-400">AGGREGATE_OK [200]</div>
                <div className="text-[10px] font-mono text-zinc-500 mt-1">{"{ pii_stripped: true, batch: 42 }"}</div>
              </div>
            </div>
            ...
            <div className="bg-white border border-zinc-200 rounded-3xl p-8 flex flex-col justify-between group shadow-sm hover:shadow-md transition-shadow">
              <div>
                ...
                <h3 className="text-xl font-semibold text-zinc-900 mb-2">Automated Accruals</h3>
                <p className="text-zinc-500 text-sm leading-relaxed">
                  Automatically generate reversing journal entries for PTO and bonus accruals at period close.
                </p>
              </div>
            </div>
            ...
            <div className="md:col-span-2 relative bg-white border border-zinc-200 rounded-3xl p-8 overflow-hidden group shadow-sm hover:shadow-md transition-shadow">
              <div className="relative z-10 h-full flex flex-col md:flex-row gap-8 items-center justify-between">
                <div className="md:w-1/2">
                  ...
                  <h3 className="text-xl font-semibold text-zinc-900 mb-2">Cost Center Sync</h3>
                  <p className="text-zinc-500 text-sm leading-relaxed">
                    Keep your Workday supervisory organizations perfectly mapped to your NetSuite department structures automatically.
                  </p>
                </div>
