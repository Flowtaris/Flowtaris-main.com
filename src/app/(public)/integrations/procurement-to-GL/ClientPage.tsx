...
export default function ProcurementToGLPage({ integration }: { integration: any }) {
      ...
      <section className="py-32 bg-white border-t border-zinc-200 relative">
        <div className="max-w-[1200px] mx-auto px-6 lg:px-12">
          ...
          <div className="text-center mb-24 max-w-2xl mx-auto">
            ...
            <p className="text-lg text-zinc-500">
              A transparent view into the exact lifecycle of a transactionfrom procurement initiation to ledger settlement.
            </p>
          </div>
