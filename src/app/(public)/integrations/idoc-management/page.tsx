...
import { ArrowRight, Database, ShieldCheck, Activity, Zap, Server, CheckCircle, ChevronRight, Lock, Code2, Network, Layers } from 'lucide-react'
import { cn } from '@/lib/utils'

export default function IDocManagementPage() {
      ...
      <section className="relative pt-40 pb-32 border-b border-zinc-200/50">
        ...
        <div className="max-w-[1200px] mx-auto px-6 lg:px-12 relative z-10">
          <div className="flex flex-col items-center text-center">
            ...
            >
              Modernize SAP.<br />
              <span className="text-zinc-400">Streamline IDocs.</span>
            </motion.h1>
        ...
        <div className="max-w-[1200px] mx-auto px-6 lg:px-12">
          <div className="mb-20 max-w-xl">
            ...
            <p className="text-lg text-zinc-500">
              We seamlessly translate modern JSON payloads into SAP-compatible IDocs and BAPI calls with fault-tolerant delivery.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-auto md:auto-rows-[300px]">
            ...
            <div className="md:col-span-2 relative bg-white border border-zinc-200 rounded-3xl p-8 overflow-hidden group shadow-sm hover:shadow-md transition-shadow">
              <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-gradient-to-bl from-orange-50 to-transparent rounded-full blur-3xl opacity-50 -translate-y-1/2 translate-x-1/3" />
              <div className="relative z-10 h-full flex flex-col justify-between">
                <div className="mb-8 md:mb-0">
                  ...
                  <h3 className="text-xl font-semibold text-zinc-900 mb-2">Native IDoc Generation</h3>
                  <p className="text-zinc-500 max-w-sm text-sm leading-relaxed">
                    Convert Coupa objects directly into ORDERS05, INVOIC02, and custom IDoc formats that SAP expects natively.
                  </p>
                </div>
                {/* Mini Visualization */}
                <div className="w-full h-24 bg-zinc-50 border border-zinc-200/60 rounded-xl flex items-center px-4 gap-4 overflow-hidden">
                  <div className="flex flex-col gap-2 w-1/3">
                    <div className="h-2 w-3/4 bg-orange-200 rounded" />
                    <div className="h-2 w-1/2 bg-orange-200 rounded" />
                  </div>
            ...
            <div className="bg-white border border-zinc-200 rounded-3xl p-8 flex flex-col justify-between group shadow-sm hover:shadow-md transition-shadow">
              <div className="mb-8 md:mb-0">
                ...
                <h3 className="text-xl font-semibold text-zinc-900 mb-2">ALE Monitoring</h3>
                <p className="text-zinc-500 text-sm leading-relaxed">
                  Deep tracking of IDoc statuses (Status 53, 51, etc) ensuring complete end-to-end visibility.
                </p>
              </div>
              <div className="h-16 bg-zinc-900 rounded-xl p-3 flex flex-col justify-center overflow-hidden">
                <div className="text-[10px] font-mono text-green-400">STATUS 53: POSTED</div>
                <div className="text-[10px] font-mono text-zinc-500 mt-1">{"IDoc 0000000000124842"}</div>
              </div>
            </div>
            ...
            <div className="bg-white border border-zinc-200 rounded-3xl p-8 flex flex-col justify-between group shadow-sm hover:shadow-md transition-shadow">
              <div>
                ...
                <h3 className="text-xl font-semibold text-zinc-900 mb-2">BAPI Fallbacks</h3>
                <p className="text-zinc-500 text-sm leading-relaxed">
                  Automatic switching to synchronous BAPI calls when immediate SAP confirmation is required.
                </p>
              </div>
            </div>
            ...
            <div className="md:col-span-2 relative bg-white border border-zinc-200 rounded-3xl p-8 overflow-hidden group shadow-sm hover:shadow-md transition-shadow">
              <div className="relative z-10 h-full flex flex-col md:flex-row gap-8 items-center justify-between">
                <div className="md:w-1/2">
                  ...
                  <h3 className="text-xl font-semibold text-zinc-900 mb-2">SAP Master Data Sync</h3>
                  <p className="text-zinc-500 text-sm leading-relaxed">
                    Keep SAP Vendor Masters, Material Masters, and Cost Centers perfectly synced with Coupa.
                  </p>
                </div>
                  ...
                  <div className="absolute inset-0 bg-zinc-50 border border-zinc-100 rounded-xl flex items-center justify-center overflow-hidden">
                    <div className="w-32 h-32 relative">
                      ...
                      <motion.div 
                        ...
                        className="absolute w-2 h-2 bg-orange-500 rounded-full -translate-x-1 -translate-y-1"
                      />
                    </div>
                  </div>
                </div>
