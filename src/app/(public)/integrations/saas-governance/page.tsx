        ...
        <div className="max-w-[1200px] mx-auto px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-[#FAFAFA] border border-zinc-200 rounded-2xl p-8">
              ...
              <h3 className="text-xl font-semibold text-zinc-900 mb-3">Automated Department Chargebacks</h3>
            ...
            <div className="bg-[#FAFAFA] border border-zinc-200 rounded-2xl p-8">
              ...
              <h3 className="text-xl font-semibold text-zinc-900 mb-3">Audit Ready</h3>
              <p className="text-zinc-500 leading-relaxed">
            ...
            <div className="bg-[#FAFAFA] border border-zinc-200 rounded-2xl p-8">
              ...
              <h3 className="text-xl font-semibold text-zinc-900 mb-3">Shadow IT Journaling</h3>
              <p className="text-zinc-500 leading-relaxed">
            ...
            <div className="bg-[#FAFAFA] border border-zinc-200 rounded-2xl p-8">
              ...
              <h3 className="text-xl font-semibold text-zinc-900 mb-3">Vendor Master Sync</h3>
              <p className="text-zinc-500 leading-relaxed">
