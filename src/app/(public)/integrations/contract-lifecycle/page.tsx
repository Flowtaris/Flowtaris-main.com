...
import { ArrowRight, Database, ShieldCheck, Activity, Zap, Server, CheckCircle, ChevronRight, Lock, Code2, Network, FileSignature } from 'lucide-react'
      ...
      <section className="relative pt-40 pb-32 border-b border-zinc-200/50">
        ...
        <div className="max-w-[1200px] mx-auto px-6 lg:px-12 relative z-10">
          <div className="flex flex-col items-center text-center">
            ...
            >
              Sign contracts.<br />
              <span className="text-zinc-400">Automate onboarding.</span>
            </motion.h1>
            ...
            >
              Connect Ironclad contract lifecycles directly to Coupa procurement. Automate supplier onboarding the second an MSA is signed.
            </motion.p>
          ...
          >
            <div className="w-full h-[400px] bg-white rounded-2xl border border-zinc-200 shadow-[0_8px_30px_rgb(0,0,0,0.04)] overflow-hidden relative p-8 flex flex-col justify-between hidden md:flex">
              ...
              <div className="flex justify-between items-center relative z-10">
                ...
                <div className="w-[280px] bg-white border border-zinc-200 rounded-xl p-5 shadow-sm">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                      <div className="text-sm font-semibold text-zinc-900">Ironclad CLM</div>
                      <div className="text-[11px] text-zinc-500 font-mono mt-0.5">SOURCE_SYSTEM</div>
                    </div>
                  </div>
                  <div className="space-y-2">
                    {['MSAs', 'NDAs', 'SOWs'].map((item, i) => (
                ...
                <div className="w-[280px] bg-white border border-zinc-200 rounded-xl p-5 shadow-sm">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                      ...
                      <div className="text-[11px] text-zinc-500 font-mono mt-0.5">TARGET_SYSTEM</div>
                    </div>
                  </div>
                  <div className="space-y-2">
                    {['Supplier Records', 'Contracts', 'Risk Profiles'].map((item, i) => (
                      <div key={i} className="flex items-center justify-between text-xs font-mono py-1.5 px-2 bg-zinc-50 rounded text-zinc-600 border border-zinc-100">
                        <span>{item}</span>
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-48 bg-white/80 backdrop-blur-md border border-zinc-200 rounded-xl p-4 shadow-lg z-20">
                <div className="text-[10px] font-mono text-zinc-400 mb-3 uppercase tracking-wider text-center">Metadata Extraction</div>
                <div className="space-y-1.5">
                  <div className="h-6 flex items-center justify-between px-2 bg-zinc-100 rounded text-[10px] font-mono text-zinc-600">
                    <span>VENDOR_MAP</span>
                    <span>100%</span>
                  </div>
                  <div className="h-6 flex items-center justify-between px-2 bg-zinc-100 rounded text-[10px] font-mono text-zinc-600">
                    <span>TERMS_SYNC</span>
                    <span>PASS</span>
                  </div>
                  <div className="h-6 flex items-center justify-between px-2 bg-purple-50 border border-purple-100 rounded text-[10px] font-mono text-purple-600">
                    <span>API_DISPATCH</span>
                    <motion.span 
        ...
        <div className="max-w-[1200px] mx-auto px-6 lg:px-12">
          <div className="mb-20 max-w-xl">
            ...
            <p className="text-lg text-zinc-500">
              Stop manually re-keying contract terms. We map Ironclad attributes directly into Coupa's supplier and contract records.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-auto md:auto-rows-[300px]">
            ...
            <div className="md:col-span-2 relative bg-white border border-zinc-200 rounded-3xl p-8 overflow-hidden group shadow-sm hover:shadow-md transition-shadow">
              <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-gradient-to-bl from-purple-50 to-transparent rounded-full blur-3xl opacity-50 -translate-y-1/2 translate-x-1/3" />
              <div className="relative z-10 h-full flex flex-col justify-between">
                <div className="mb-8 md:mb-0">
                  ...
                  <h3 className="text-xl font-semibold text-zinc-900 mb-2">Automated Supplier Onboarding</h3>
                  <p className="text-zinc-500 max-w-sm text-sm leading-relaxed">
                    When an MSA is fully executed in Ironclad, automatically trigger the supplier creation workflow in Coupa with all extracted metadata.
                  </p>
                </div>
                {/* Mini Visualization */}
            ...
            <div className="bg-white border border-zinc-200 rounded-3xl p-8 flex flex-col justify-between group shadow-sm hover:shadow-md transition-shadow">
              <div className="mb-8 md:mb-0">
                ...
                <h3 className="text-xl font-semibold text-zinc-900 mb-2">Term Synchronization</h3>
                <p className="text-zinc-500 text-sm leading-relaxed">
                  Payment terms, expiration dates, and renewal clauses are perfectly synced.
                </p>
              </div>
              <div className="h-16 bg-zinc-900 rounded-xl p-3 flex flex-col justify-center overflow-hidden">
                <div className="text-[10px] font-mono text-green-400">TERMS_SYNC [200]</div>
                <div className="text-[10px] font-mono text-zinc-500 mt-1">{"{ net_terms: 45, auto_renew: false }"}</div>
              </div>
            </div>
            ...
            <div className="bg-white border border-zinc-200 rounded-3xl p-8 flex flex-col justify-between group shadow-sm hover:shadow-md transition-shadow">
              <div>
                ...
                <h3 className="text-xl font-semibold text-zinc-900 mb-2">PDF Attachment Sync</h3>
                <p className="text-zinc-500 text-sm leading-relaxed">
                  Automatically push the finalized, executed PDF contract from Ironclad into the Coupa contract record.
                </p>
              </div>
            </div>
            ...
            <div className="md:col-span-2 relative bg-white border border-zinc-200 rounded-3xl p-8 overflow-hidden group shadow-sm hover:shadow-md transition-shadow">
              <div className="relative z-10 h-full flex flex-col md:flex-row gap-8 items-center justify-between">
                <div className="md:w-1/2">
                  ...
                  <h3 className="text-xl font-semibold text-zinc-900 mb-2">Status Back-Sync</h3>
                  <p className="text-zinc-500 text-sm leading-relaxed">
                    Keep Ironclad updated with the Coupa onboarding status, providing legal teams visibility into procurement milestones.
                  </p>
                </div>
                  ...
                  <div className="absolute inset-0 bg-zinc-50 border border-zinc-100 rounded-xl flex items-center justify-center overflow-hidden">
                    <div className="w-32 h-32 relative">
                      ...
                      <motion.div 
                        ...
                        className="absolute w-2 h-2 bg-purple-500 rounded-full -translate-x-1 -translate-y-1"
                      />
                    </div>
                  </div>
                </div>
        ...
        <div className="max-w-[1200px] mx-auto px-6 lg:px-12">
          ...
          <div className="flex flex-col lg:flex-row bg-[#FAFAFA] rounded-3xl border border-zinc-200 overflow-hidden shadow-sm">
            ...
            <div className="lg:w-2/5 border-b lg:border-b-0 lg:border-r border-zinc-200 p-8">
              <div className="space-y-2">
                {[
                  { id: 'WF_COMPLETE', title: 'Contract Signed', sys: 'Ironclad' },
                  { id: 'META_EXTRACT', title: 'Metadata Extraction', sys: 'Middleware' },
                  { id: 'SUPP_CREATE', title: 'Supplier Creation', sys: 'Coupa' },
                  { id: 'STAT_SYNC', title: 'Status Back-Sync', sys: 'Ironclad' }
                ].map((step, i) => (
                  <button
                    key={i}
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 text-[11px] font-mono">
                        ...
                        <span className={activeStep === i ? "text-purple-600 font-semibold" : "text-zinc-400"}>{step.sys}</span>
                      </div>
                    </div>
                  </button>
                ))}
              ...
              <div className="flex items-center justify-between mb-8 pb-4 border-b border-zinc-100">
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-xs font-mono text-zinc-500 hidden sm:block">
                    {activeStep === 0 ? '/api/ironclad/workflow' : activeStep === 1 ? '/sys/transform/meta' : activeStep === 2 ? '/api/coupa/supplier' : '/sys/sync'}
                  </div>
                </div>
                <div className="flex items-center gap-2 text-xs font-mono">
                  <span className="text-zinc-400">latency:</span>
                  <span className="text-green-600 font-semibold">{25 + activeStep * 12}ms</span>
                </div>
              </div>
...
{`{
  ...
  "payload": {
    "workflow_id": "WF-88992",
    "contract_type": "Master Services Agreement",
    "status": "fully_signed",
    "attributes": {
      "counterparty_name": "Stripe Inc",
                    ...
                    {activeStep === 1 && (
                      <div className="space-y-4">
                        <div className="p-3 bg-zinc-50 rounded border border-zinc-100">
                          <span className="text-zinc-400">[SYSTEM]</span> Extracting attributes from Ironclad workflow WF-88992...
                        </div>
                        <div className="p-3 bg-zinc-50 rounded border border-zinc-100 flex items-center gap-2">
                          <CheckCircle className="w-3 h-3 text-green-500" />
                          <span>Mapped counterparty to Coupa Supplier format. Extracted PDF document.</span>
                        </div>
                        <div className="p-3 bg-purple-50/50 rounded border border-purple-100/50 flex gap-2">
                          <span className="text-purple-600 font-semibold">{"->"}</span> Dispatching to Coupa API.
                        </div>
                      </div>
                    )}
                    {activeStep === 2 && (
                    ...
                    {activeStep === 3 && (
                      <div className="h-full flex flex-col justify-center py-8">
                        ...
                        <div className="text-center">
                          <div className="text-zinc-400 mb-2">Coupa Supplier ID</div>
                          <div className="text-xl sm:text-2xl font-mono text-zinc-900 tracking-tight">10098</div>
                        </div>
                      </div>
                    )}
                  </motion.div>
      ...
      <section className="py-32 bg-white relative">
        <div className="max-w-[800px] mx-auto px-6 text-center">
          <h2 className="text-4xl font-medium tracking-tight text-zinc-900 mb-6" style={{ fontFamily: 'var(--font-sora)' }}>
            Ready to unify your legal and finance stack?
          </h2>
