        ...
        <div className="max-w-[1200px] mx-auto px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-[#FAFAFA] border border-zinc-200 rounded-2xl p-8">
              ...
              <h3 className="text-xl font-semibold text-zinc-900 mb-3">Automated Supplier Onboarding</h3>
            ...
            <div className="bg-[#FAFAFA] border border-zinc-200 rounded-2xl p-8">
              ...
              <h3 className="text-xl font-semibold text-zinc-900 mb-3">Term Synchronization</h3>
              <p className="text-zinc-500 leading-relaxed">
                Payment terms, expiration dates, and renewal clauses are perfectly synced from the legal document to the procurement profile.
              </p>
            </div>
            ...
            <div className="bg-[#FAFAFA] border border-zinc-200 rounded-2xl p-8">
              ...
              <h3 className="text-xl font-semibold text-zinc-900 mb-3">PDF Attachment Sync</h3>
              <p className="text-zinc-500 leading-relaxed">
                Automatically push the finalized, executed PDF contract from Ironclad into the Coupa contract record for centralized visibility.
              </p>
            </div>
            ...
            <div className="bg-[#FAFAFA] border border-zinc-200 rounded-2xl p-8">
              ...
              <h3 className="text-xl font-semibold text-zinc-900 mb-3">Status Back-Sync</h3>
              <p className="text-zinc-500 leading-relaxed">
